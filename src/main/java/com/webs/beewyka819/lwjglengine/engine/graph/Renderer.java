...
import com.webs.beewyka819.lwjglengine.engine.Utils;
...
public class Renderer {
    ...
    private void setupDepthShader() throws Exception {
        ...
        depthShaderProgram.createVertexShader(Utils.loadResource("/res/shaders/depth_vertex.vs"));
        depthShaderProgram.createFragmentShader(Utils.loadResource("/res/shaders/depth_fragment.fs"));
    ...
    private void setupSkyBoxShader() throws Exception {
        ...
        skyBoxShaderProgram.createVertexShader(Utils.loadResource("/res/shaders/sb_vertex.vs"));
        skyBoxShaderProgram.createFragmentShader(Utils.loadResource("/res/shaders/sb_fragment.fs"));
    ...
    private void setupSceneShader() throws Exception {
        ...
        sceneShaderProgram.createVertexShader(Utils.loadResource("/res/shaders/scene_vertex.vs"));
        sceneShaderProgram.createFragmentShader(Utils.loadResource("/res/shaders/scene_fragment.fs"));
    ...
    private void setupHudShader() throws Exception {
        ...
        hudShaderProgram.createVertexShader(Utils.loadResource("/res/shaders/hud_vertex.vs"));
        hudShaderProgram.createFragmentShader(Utils.loadResource("/res/shaders/hud_fragment.fs"));
    ...
    private void renderSkyBox(Window window, Camera camera, Scene scene) throws Exception {
