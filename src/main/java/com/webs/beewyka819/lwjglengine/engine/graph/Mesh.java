...
public class Mesh {
    ...
    public Mesh(float[] positions, float[] textureCoords, float[] normals, int[] indices) {
        ...
        try {
            ...
            glVertexAttribPointer(1, 2, GL_FLOAT, false, 0, (Float.SIZE / BITS_PER_BYTE) * positions.length);
            glVertexAttribPointer(2, 3, GL_FLOAT, false, 0, (Float.SIZE / BITS_PER_BYTE) * (positions.length + textureCoords.length));
